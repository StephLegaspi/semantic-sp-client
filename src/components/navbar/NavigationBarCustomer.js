		...
		return (
			<div>
				<Menu fixed='top' id='menu-div'>
			    	...
			    	<Container>
				        <Menu.Item as='a'  id={this.props.activePage[7] ? 'lighter': 'menu-font'} onClick={this.toPortfolio} style={{marginLeft: '37.5%'}} >Portfolio</Menu.Item>
				    ...
				    <Container>
				        <Menu.Item as='a'  id={this.props.activePage[7] ? 'lighter': 'menu-font'} onClick={this.toPortfolio} style={{marginLeft: '37%'}} >Portfolio</Menu.Item>
				        <Menu.Item as='a' id={this.props.activePage[8] ? 'lighter': 'menu-font'} onClick={this.toContactUs}>Contact Us</Menu.Item>
